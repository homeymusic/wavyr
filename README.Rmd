...
![A frequency shift to the nearest co-prime rational fraction within the uncertainty limit.](man/figures/rationalize_within_uncertainty.png)
...
![Coprime rational fractions.](man/figures/numbers.png)
...
* All plots should have a 1D temporal signal (time series), and a 2D spatial signal (image).
* Plot a wave that is as close to harmonic as possible but not, like a ET P5 relationship with octave doubling.
  * show the idealized
