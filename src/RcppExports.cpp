...
// sparse_spectrum_sbg_cpp
DataFrame sparse_spectrum_sbg_cpp(int nrows, int ncols, double uncertainty);
RcppExport SEXP _wavyr_sparse_spectrum_sbg_cpp(SEXP nrowsSEXP, SEXP ncolsSEXP, SEXP uncertaintySEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(sparse_spectrum_sbg_cpp(nrows, ncols, uncertainty));
    return rcpp_result_gen;
END_RCPP
}
